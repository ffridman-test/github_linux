...
<html>
    ...
    <head><link rel="alternate" type="text/xml" href="/Imed/WsConfirmacion.asmx?disco" />
  ...
  <body>
    ...
    <div id="content">
      ...
      <p class="heading1">WsConfirmacion</p><br>

      

      <span>

          <p class="intro">The following operations are supported.  For a formal definition, please review the <a href="WsConfirmacion.asmx?WSDL">Service Description</a>. </p>
          
          
              <ul>
            
              <li>
                <a href="WsConfirmacion.asmx?op=wmImed_SrvConfirmacion">wmImed_SrvConfirmacion</a>
